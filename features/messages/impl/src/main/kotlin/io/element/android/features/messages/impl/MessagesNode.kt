    ...
    override fun View(modifier: Modifier) {
        ...
        CompositionLocalProvider(
            ...
            MessagesView(
                ...
                onLinkClick = { url -> onLinkClick(activity, isDark, url, state.timelineState.eventSink, false) },
                onHelpLinkClick = { url -> onLinkClick(activity, isDark, url, state.timelineState.eventSink, true) },
